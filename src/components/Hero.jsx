...
const Hero = ({ hero: { title, subtitle, btn1, btn2, text, img } }) => {
  return (
    <>
      <div className=" flex flex-col bg-gradient-to-b from-emerald-200 to-white">
        <div className="travigo-container grid items-start justify-items-center">
          ...
          <div className=" flex items-center justify-center mb-11">
            <img
              src={img}
              alt="dashboard/img"
              className=" h-[85vh] w-full object-fill lg:h-[75vh] md:h-[57vh] sm:h-[35vh] sm:object-contain drop-shadow-emraldy"
            />
          </div>
        </div>
      </div>
