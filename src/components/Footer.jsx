        ...
        <div className=" grid items-center grid-cols-3 justify-items-center">
          {titles?.map((val, i) => (
            <div className=" grid items-center justify-items-center">
              <h1
                key={i}
                className=" text-xl lg:text-base uppercase font-semibold cursor-pointer"
              >
                {" "}
                {val.title}{" "}
              </h1>
          ...
          {links?.map((list, i) => (
            ...
            >
              {list?.map((val, i) => (
                <li
                  key={i}
                  className=" font-mono text-sm sm:text-xs cursor-pointer"
                >
                  {val.link}
                </li>
              ))}
        ...
        <div className=" w-7/12 lg:w-[95vw] m-auto mt-9">
          ...
          <div className=" flex items-center justify-between px-7 md:px-0 md:gap-5 md:flex-col-reverse">
            <p className=" text-sm md:text-center">
              ...
              <span className=" font-semibold">Shahwaz Developer</span>
            </p>
